...
class CronUploaderUserConfig extends UserConfigGroup
{
    ...
    #[ConfigMeta("Stop on error", ConfigType::BOOL, default: false, permission: Permissions::CRON_ADMIN)]
    public const STOP_ON_ERROR = "cron_uploader_stop_on_error";

    #[ConfigMeta("Include all logs", ConfigType::BOOL, default: false, permission: Permissions::CRON_ADMIN)]
    public const INCLUDE_ALL_LOGS = "cron_uploader_include_all_logs";

    #[ConfigMeta("Log level", ConfigType::STRING, default: LogLevel::INFO->value, options: "Shimmie2\LogLevel::names_to_levels", permission: Permissions::CRON_ADMIN)]
