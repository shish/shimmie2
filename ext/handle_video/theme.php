        ...
        $html = emptyHTML(
            ...
            VIDEO(
                [
                    ...
                    'autoplay' => Ctx::$config->req(VideoFileHandlerConfig::PLAYBACK_AUTOPLAY),
                    'loop' => Ctx::$config->req(VideoFileHandlerConfig::PLAYBACK_LOOP),
                    'muted' => Ctx::$config->req(VideoFileHandlerConfig::PLAYBACK_MUTE),
