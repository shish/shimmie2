...
final class UtilTest extends TestCase
{
    ...
    {
        self::assertSame("default", get_theme());
    }
    ...
    {
        self::assertSame("123.00B", human_filesize(123));
        self::assertSame("123B", human_filesize(123, 0));
        self::assertSame("120.56KB", human_filesize(123456));
    }
