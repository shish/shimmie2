 ...
 */
function _dump_event_listeners(array $event_listeners, string $path): string
{
    $header = "<"."?php\nnamespace Shimmie2;\n";

    $classes = [];
    $listeners = "return array(\n";
    ...
    foreach($classes as $scn) {
        $class_objs .= "\$$scn = new $scn(); ";
    }

    return $header . $class_objs . $listeners;
}
