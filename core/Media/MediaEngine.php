...
enum MediaEngine: string
{
    ...
    public static function is_output_supported(MediaEngine $engine, string $mime): bool
    {
    ...
    public static function is_input_supported(MediaEngine $engine, string $mime): bool
    {
        return MimeType::matches_array(
            $mime,
